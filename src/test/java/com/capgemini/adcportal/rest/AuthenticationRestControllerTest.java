package com.capgemini.adcportal.rest;

import com.capgemini.adcportal.model.security.Authority;
import com.capgemini.adcportal.model.security.AuthorityName;
import com.capgemini.adcportal.model.security.User;
import com.capgemini.adcportal.security.JwtAuthenticationRequest;
import com.capgemini.adcportal.security.JwtTokenUtil;
import com.capgemini.adcportal.security.JwtUser;
import com.capgemini.adcportal.security.JwtUserFactory;
...
public class AuthenticationRestControllerTest {
    ...
    @Test
    @WithMockUser(roles = "ROLE_USERADMIN")
    public void successfulRefreshTokenWithUserRole() throws Exception {

        Authority authority = new Authority();
        authority.setId(0L);
        authority.setName(AuthorityName.ROLE_USERADMIN);
